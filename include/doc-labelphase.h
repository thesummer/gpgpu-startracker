...
/*!
  ...
  Stage 1 is only done once whereas stages 2 and 3 are done in an iteratitve manner.
   ...
   However for the computation of the computation of the weighted centroid of each star spot
   ...
   are set to zero too. This filters out the numerous "hot pixels" in the beginning. Figure 2 the result
   of this stage.
   ...
   Finally in the consolidation stage each non-zero pixel read the value of the pixel its label points to and assigns this value to itself.
